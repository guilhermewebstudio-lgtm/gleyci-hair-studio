(function () {
  const KB = {
    pt: {
      ...
      fallback: "Não tenho a certeza sobre isso — mas podes falar diretamente com a Gleyci pelo WhatsApp (botão verde aqui ao lado) que ela responde rapidinho!",
      rules: [
        ...
        { test: /\b(local|onde fica|morada|endereço|lisboa)\w*/i, reply: () => "Estamos em Lisboa. Para a morada exata, o mais rápido é perguntar diretamente à Gleyci pelo WhatsApp ou Instagram (botões aqui ao lado)." },
        ...
        { test: /\b(whatsapp|telefone|contact|falar com)\w*/i, reply: () => "Claro! Usa o botão verde do WhatsApp aqui ao lado para falares diretamente com a Gleyci." },
    ...
    en: {
      ...
      fallback: "I'm not sure about that — but you can message Gleyci directly on WhatsApp (green button here) and she'll get back to you quickly!",
      rules: [
        ...
        { test: /\b(locat|where|address|lisbon)\w*/i, reply: () => "We're based in Lisbon. For the exact address, the fastest way is to ask Gleyci directly via WhatsApp or Instagram (buttons here)." },
        ...
        { test: /\b(whatsapp|phone|contact|talk to)\w*/i, reply: () => "Sure! Use the green WhatsApp button here to talk directly with Gleyci." },
